					...
					<article className="grid min-w-0 gap-4 text-[15px] leading-relaxed sm:text-base">
						...
						<section
							...
							<ul className={listClassName}>
								...
								<li>
									выбор настроек cookies: выбранный режим, версия уведомления и дата
									выбора; эти сведения сохраняются локально на устройстве.
								</li>
							</ul>
						...
						<section
							...
							<p className="mt-4 text-ink-muted">
								На странице контактов доступна Яндекс Карта. По умолчанию она не
								загружается. После явного разрешения браузер подключается к сервису
								Яндекса, который может получить IP-адрес и другие технические данные,
								а также использовать собственные cookies в соответствии с его
								{" "}
								<a
							...
							<p className="mt-4 text-ink-muted">
								В текущей версии сайта рекламные и аналитические cookies не
								используются. Корзина, избранное и запись выбора cookies работают через
								локальное хранилище браузера и не отправляются на сервер автоматически.
								Пользователь может оставить только необходимые функции, разрешить
								Яндекс Карту или в любой момент изменить выбор через ссылку «Настройки
								cookies» в нижней части сайта.
							</p>
							<p className="mt-4 text-ink-muted">
